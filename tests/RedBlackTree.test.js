...
// custom inorder function to help tet colors and all references of tree
function Test(node){
   if(node){
     let tmp= [];
...
describe("RB", function(){
  ...
  it("insert into empty tree should recolor root", function(){
   ...
   it("insert should recolor p and uncle when uncle is red", function(){
    ...
    rb.insert(0, 44);
    rb.insert(3, 7)
    let actual= Test(rb.root)
    let expected= [{key: undefined, value: undefined, color: "black"}, {key: 0, value: 44, color: "black"},
  ...
  it("insert should rotate on RR case when uncle is black", function(){
    ...
    let actual= Test(rb.root)
    let expected= [{key: undefined, value: undefined, color: "black"}, {key: 20, value: 2, color: "red"},
                  {key: undefined, value: undefined, color: "black"},
  ...
  it("insert should rotate on RL case when uncle is black", function(){
    ...
    rb.insert(5, 5);
    let actual= Test(rb.root)
    let expected= [{key: undefined, value: undefined, color: "black"}, {key: 5, value: 5, color: "red"},
                  {key: undefined, value: undefined, color: "black"},
    ...
    rb.insert(15, 5);
    let actual= Test(rb.root)
    let expected= [{key: undefined, value: undefined, color: "black"}, {key: 10, value: 3, color: "red"},
                  {key: undefined, value: undefined, color: "black"},
    ...
    rb.remove(30);
    let actual= Test(rb.root)
    let expected= [{key: undefined, value: undefined, color: "black"}, {key: 10, value: 5, color: "red"},
                  {key: undefined, value: undefined, color: "black"},
   ...
   it("delete should fix double black case-sibling is right child and red is right", function(){
    ...
    rb.remove(20);
    let actual= Test(rb.root)
    let expected= [{key: undefined, value: undefined, color: "black"}, {key: 30, value: 3, color: "black"},
                  {key: undefined, value: undefined, color: "black"},
   ...
   it("delete should fix double black case-sibling right child and red is left", function(){
    ...
    rb.remove(30);
    let actual= Test(rb.root)
    let expected= [{key: undefined, value: undefined, color: "black"}, {key: 40, value: 4, color: "black"},
                  {key: undefined, value: undefined, color: "black"},
   ...
   it("delete should fix double black case-sibling is black and both sibling's children are black (node deleted was left child)", function(){
    ...
    let actual= Test(rb.root)
    let expected= [{key: undefined, value: undefined, color: "black"}, {key: 20, value: 3, color: "black"},
                  {key: undefined, value: undefined, color: "black"},
    ...
    let actual= Test(rb.root)
    let expected= [{key: undefined, value: undefined, color: "black"}, {key: 10, value: 2, color: "red"},
                  {key: undefined, value: undefined, color: "black"},
    ...
    let actual= Test(rb.root)
    let expected= [{key: undefined, value: undefined, color: "black"}, {key: 20, value: 20, color: "black"},
                  {key: undefined, value: undefined, color: "black"},
    ...
    let actual= Test(rb.root)
    let expected= [{key: undefined, value: undefined, color: "black"}, {key: 5, value: 5, color: "black"},
                  {key: undefined, value: undefined, color: "black"},
